...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'Generates sites for running clubs.'
  spec.description   = 'Generates sites for running clubs.'
  spec.homepage      = 'https://github.com/running-clubs/generator'
  spec.license       = 'MIT'
